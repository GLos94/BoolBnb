...
<div class="container" style="max-width: 1350px;">
            ...
            @else
              ...
              <div class="col-xs-12 col-lg-4 text-center" style="margin-bottom:20px;">
                  ...
                  <div class="title-description">
                      <h2 style="font-size:16px;text-align: center;}"><a href="{{route('show', $flat -> id )}}">{{$flat -> title}}</a></h2>
    ...
    <div class="container services" style="max-width: 1350px;">
      <h2>Una casa ovunque nel mondo</h2>
      <div class="row justify-content-center" style="margin:45px 0;">
        <div class="col-xs-12 col-lg-3 text-center">
          <img src="https://a0.muscache.com/im/pictures/a0316ecb-e49b-4b3a-b6b6-c2876b820e8c.jpg" width="320px" alt="">
          <h6>Case intere</h6>
        </div>
        <div class="col-xs-12 col-lg-3 text-center">
          <img src="https://a0.muscache.com/im/pictures/ff69ac49-64e7-4f4a-ae2b-ee01163d0790.jpg" width="320px" alt="">
          <h6>Chalet e cottage</h6>
        </div>
        <div class="col-xs-12 col-lg-3 text-center">
          <img src="https://a0.muscache.com/im/pictures/ce6814ba-ed53-4d6e-b8f8-c0bbcf821011.jpg" width="320px" alt="">
          <h6>Spazi unici</h6>
        </div>
        <div class="col-xs-12 col-lg-3 text-center">
          <img src="https://a0.muscache.com/im/pictures/fbe849a4-841a-41b3-b770-419402a6316f.jpg" width="320px" alt="">
          <h6>Animali domestici accettati</h6>
        </div>
      </div>
    </div>
</div>
